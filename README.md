...
Catàleg i fitxes amb RLS; registre, confirmació, entrada, recuperació, canvi de contrasenya i logout; cookies HttpOnly i MFA TOTP; administració d'inventari protegida per permisos i MFA; ajustos d'estoc atòmics i idempotents amb auditoria. Cap administrador permanent creat. Migracions i proves versionades.

Pendent: gestió de catàleg, reserves d'inventari, carret, checkout, comandes, devolucions, PWA i desplegament de producció.
